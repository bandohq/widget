...
interface ProductSearchProps {
  onSearchChange: (query: string, countryCode?: string) => void;
}

export const ProductSearch = ({ onSearchChange }: ProductSearchProps): JSX.Element | null => {
  ...
  const handleCountryChange = (event: ChangeEvent<{ value: unknown }>): void => {
  ...
  return (
    <SearchContainer>
      ...
      <CountrySelect
        ...
        onChange={(event) => handleCountryChange(event as ChangeEvent<{ value: unknown }>)}
        displayEmpty
